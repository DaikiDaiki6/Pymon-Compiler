...
class Sem:
        ...
        try:
            ...
            if cond_result == "nocap":
                while self.c1 != '<loop if->': #run the loop if body if cond_result is nocap
                    if self.c1 == '<output statement+>':
                        self.output_statement()
                    elif self.c1 in ['<loop if+>', '<loop elif+>', '<loop else+>']:
                        a = self.loop_condition() # if in loop condition there is a break, it will return "stop", then it will stop the program
                        if a == "stop":
                            break
    ...
    def loop_statement(self):
        try:
            if self.c1 == '<poor loop+>':  # if loop statement is a for loop then go here
                self.next()
                id1 = str(self.value[self.c2]) + "loop3r"  # later
                ...
                self.next()
                start = self.c2 + 1  # get the range parameters for "for loop"
                while self.c1 != '<range->':
                    self.next()
                end = self.c2
                    ...
                    for _ in range(result):
                        ...
                        while self.c1 != '<poor loop->':  # execute the poor loop body
                            if self.c1 == '<output statement+>':
                                ...
                                a = self.loop_condition()  # return "stop" if there is a break inside the condition
                                if a == "stop":
                                    break
                            elif self.c1 in ['<poor loop+>', '<checkif loop+>']:
                                self.loop_statement()
    ...
    def declaration(self):
        try:
            ...
            while self.c1 != '<declaration->':
                if self.c1 == '<data type>' and ctr < 2:
            ...
            if self.c11 == '<function poor loop+>':  # if loop statement is a for loop then go here
                ...
                if cond_result == "nocap":
                    while cond_result == "nocap":
                        ...
                        loop_ctr += 1
                        self.funcnext()
                        if self.c11 == '<function checkif loop->':
                            break
                elif cond_result == "cap": #if result is cap then skip loop statement
                    while self.c11 != '<function checkif loop->':
                        self.funcnext()
    ...
    def func_loop_condition(self):
        try:
            remit = "None"
            while self.c11 != '<condition+>':  # skip the structure to condition
                self.funcnext()
            cond_result = self.func_condition()  # get result of condition if cap or nocap
            if cond_result == "nocap":
                while self.c11 != '<function loop if->':  # run the loop if body if cond_result is nocap
                    if self.c11 == '<output statement+>':
                        self.func_output()
                    elif self.c11 == '<function loop condition+>':
                        a = self.func_loop_condition()
